...
const Home = () => {
	...
	const [gameCoordinates] = useState(() =>
		generateNonOverlappingPositions(games.length - 1, SAFE_ZONE, 12)
	);
				...
				<div className="treasure-hunt-page ">
					<div className="left-panel">
						...
						{games.slice(0, -1).map((game, idx) => {
							...
							return (
								<div
									key={game.id}
									className={`game-coordinate ${
										game.status === "locked" ? "locked" : "unlocked"
									}`}
									style={{
										top: `${pos.top}%`,
										left: `${pos.left}%`,
					...
					<div className="right-panel">
						...
						<div className="story-box hidden-scroll">
							<span
								className="story-text typing-multiline"
								style={{ "--n": dummyStory.length + 5 } as CSSProperties}
							>
								{dummyStory}
							</span>
						</div>
