					...
					<div className="absolute inset-0 flex flex-col items-center">
						...
						<div className="w-[85%] sm:w-[80%] md:w-[75%] lg:w-[70%] max-h-[60%] sm:max-h-[58%] md:max-h-[55%] overflow-auto p-4 sm:p-5 md:p-6 rounded">
							...
							<div className="mb-4 md:mb-6">
								...
								<p className="text-base sm:text-base md:text-lg text-amber-950 leading-relaxed font-medium">
									Trở về tương lai đưa bạn trở về quá khứ để khám phá những thay
									đổi đáng kinh ngạc tại các di tích và danh lam thắng cảnh Việt
									Nam. So sánh bản đồ cổ và hiện đại để tìm ra những điểm khác
									biệt đã thay đổi theo dòng lịch sử.
								</p>
							</div>
							...
							<div className="mb-4 md:mb-6 bg-amber-50/30 p-3 rounded-lg border border-amber-700/30">
								<h2 className="text-xl sm:text-xl md:text-2xl font-pirate mb-2 md:mb-3 text-amber-900 text-shadow-light flex items-center">
									<FaMapMarkedAlt className="mr-2 text-amber-800" /> Chọn địa
									điểm
								</h2>
								...
								<div className="mt-3 p-2 bg-amber-100/50 rounded border border-amber-700/20">
									<p className="italic text-amber-900">
										Khám phá những thay đổi tại {selectedLocation.name} qua
										nhiều thế kỷ
									</p>
								</div>
							</div>
						...
						<div className="flex gap-4 sm:gap-6 md:gap-8 mb-[10%] sm:mb-[8%] md:mb-[6%] lg:mb-[5%] justify-center p-2 rounded">
							<ButtonSound
								...
								title={t("description4.back")}
							>
								<FaHome size={24} />
							</ButtonSound>
							<ButtonSound
								onClick={() => navigate("/game4/settings")}
								className="w-16 h-16 sm:w-20 sm:h-20 bg-amber-700 hover:bg-amber-800 text-amber-50 rounded-xl transition-all duration-300 shadow-xl border-2 border-amber-600 hover:scale-110 flex items-center justify-center"
								title={t("settings")}
							>
								<FaCog size={24} />
							...
							<ButtonSound
								onClick={() =>
									navigate(`/game4/game?location=${selectedLocation.id}`)
								}
