...
import Game2 from "./game.component";
import Game2Setting from "./game-setting.component";
...
export default function Description2() {
	...
	if (view === "game") return <Game2 />;
	if (view === "setting") return <Game2Setting />;
