...
import Game10 from "./game.component";
import Game10Setting from "./game-setting.component";
import ButtonSound from "../../feature/button-sound/button-sound.component";

export default function Description10() {
	...
	if (view === "game") return <Game10 />;
	if (view === "setting") return <Game10Setting />;
