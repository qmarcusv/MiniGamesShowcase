...
import Game9 from "./game.component";
import Game9Setting from "./game-setting.component";
...
export default function Description9() {
	...
	if (view === "game") return <Game9 />;
	if (view === "setting") return <Game9Setting />;
