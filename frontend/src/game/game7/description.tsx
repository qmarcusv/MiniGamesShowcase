...
import Game7 from "./game.component";
import Game7Setting from "./game-setting.component";
import ButtonSound from "../../feature/button-sound/button-sound.component";

export default function Description7() {
	...
	if (view === "game") return <Game7 />;
	if (view === "setting") return <Game7Setting />;
